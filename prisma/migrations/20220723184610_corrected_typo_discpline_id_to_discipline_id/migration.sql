/*
  ...
  - You are about to drop the column `discplineId` on the `teachersDisciplines` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "teachersDisciplines" DROP CONSTRAINT "teachersDisciplines_discplineId_fkey";

-- AlterTable
ALTER TABLE "teachersDisciplines" DROP COLUMN "discplineId",
